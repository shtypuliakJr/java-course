...
class View {
    ...
    private static final String OUTPUT_STATISTIC = "Statistic of your input:";
    ...
    public void printResults(int guessedNumber, ArrayList arrayList) {
        System.out.println(NUMBER_EQUALS_TO_HIDDEN.formatted(guessedNumber));
        System.out.println(OUTPUT_STATISTIC);
